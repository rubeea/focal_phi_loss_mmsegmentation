...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert Mendeley dataset to mmsegmentation format')
    parser.add_argument(
        'train_images_path', help='the train images part of Mendeley dataset')
    parser.add_argument(
        'train_labels_path', help='the train labels part of Mendeley dataset')
    parser.add_argument(
        'val_images_path', help='the val images part of Mendeley dataset')
    parser.add_argument(
        'val_labels_path', help='the val labels part of Mendeley dataset')
...
def main():
    ...
    if args.out_dir is None:
        out_dir = osp.join('/content/focal_phi_loss_mmsegmentation/data', 'mendeley')
    else:
